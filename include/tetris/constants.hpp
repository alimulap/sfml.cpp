...
static inline const sf::Vector2f P1 = sf::Vector2f(0.0f, 0.0f);
static inline const sf::Vector2f P2 = sf::Vector2f(1.0f, 0.0f);
static inline const sf::Vector2f P3 = sf::Vector2f(1.0f, 1.0f);
static inline const sf::Vector2f P4 = sf::Vector2f(0.0f, 1.0f);
static inline const sf::Vector2f P5 = sf::Vector2f(0.2f, 0.2f);
static inline const sf::Vector2f P6 = sf::Vector2f(0.8f, 0.2f);
static inline const sf::Vector2f P7 = sf::Vector2f(0.8f, 0.8f);
static inline const sf::Vector2f P8 = sf::Vector2f(0.2f, 0.8f);
