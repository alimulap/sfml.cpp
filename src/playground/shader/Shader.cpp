...
public:
    ...
    bool onLoad()
    {
        ...
        if (!m_texture.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/background.jpg"))
            return false;
        m_sprite.setTexture(m_texture);

        // Load the shader
        if (!m_shader.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/pixelate.frag", sf::Shader::Fragment))
            return false;
...
public:
    ...
    bool onLoad()
    {
        ...
        // Load the shader
        if (!m_shader.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/wave.vert", "C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/blur.frag"))
            return false;
...
public:
    ...
    bool onLoad()
    {
        ...
        // Load the shader
        if (!m_shader.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/storm.vert", "C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/blink.frag"))
            return false;
...
public:
    ...
    bool onLoad()
    {
        ...
        // Load the textures
        if (!m_backgroundTexture.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/sfml.png"))
            return false;
        m_backgroundTexture.setSmooth(true);
        if (!m_entityTexture.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/devices.png"))
            return false;
        ...
        // Load the shader
        if (!m_shader.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/edge.frag", sf::Shader::Fragment))
            return false;
        m_shader.setUniform("texture", sf::Shader::CurrentTexture);
...
public:
    ...
    bool onLoad()
    {
        ...
        // Load the texture
        if (!m_logoTexture.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/logo.png"))
            return false;

        // Load the shader
        if (!m_shader.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/billboard.vert", "C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/billboard.geom", "C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/billboard.frag"))
            return false;
        m_shader.setUniform("texture", sf::Shader::CurrentTexture);
...
int shader()
{
    ...
    sf::Font font;
    if (!font.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/tuffy.ttf"))
        return EXIT_FAILURE;
    Effect::setFont(font);
    ...
    if (!textBackgroundTexture.loadFromFile("C:/Users/user/Abyss/Gamedev/SFML-Project/Cpp/sfml.cpp/include/resources/text-background.png"))
        return EXIT_FAILURE;
